...
const SensorDeviceType = ({ children, ...props }) => (
  <tr>
    ...
    { !props.deviceFeature.deviceFeatureName && props.deviceFeature.type === 'binary' && <td>{props.deviceFeature.name}</td>}
    { !props.deviceFeature.deviceFeatureName && props.deviceFeature.type !== 'binary' && <td>{props.deviceFeature.name} - {props.deviceFeature.type}</td>}
