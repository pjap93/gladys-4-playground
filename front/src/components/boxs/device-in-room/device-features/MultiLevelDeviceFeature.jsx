...
const MultiLevelDeviceType = ({ children, ...props }) => {
  ...
  function updateValue(e) {
    props.updateValue(props.deviceFeature, props.roomIndex, props.deviceFeatureIndex, e.target.value, props.deviceFeature.lastValue);
  }
  ...
  return (
    <tr>
      ...
      { !props.deviceFeature.deviceFeatureName && <td>{props.deviceFeature.name} - {props.deviceFeature.type}</td>}
      ...
      <td class="text-right" style="padding-top: 0px; padding-bottom: 0px">
        <div class="col">
          <input
            ...
            min={props.deviceFeature.min} max={props.deviceFeature.max}
          />
        </div>
      </td>
    </tr>
