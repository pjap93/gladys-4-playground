                ...
                {props.user && (
                  <div class="card-body text-center">
                    <img
                      ...
                      src={props.user.profile_url || '/assets/images/undraw_profile_pic.svg'}
                    />
                    <h3 class="mb-3">{props.user.name}</h3>
                    <p class="mb-4">{props.user.role === 'admin' ? 'Administrator' : 'User'}</p>
                  </div>
                )}
              </div>
            </div>
                    ...
                    <form onSubmit={props.saveUser}>
                      ...
                      <div class="form-group">
                        ...
                        <input
                          ...
                          value={props.newUser.newPassword}
                      ...
                      <div class="form-group">
                        ...
                        <input
                          ...
                          class="form-control"
                          placeholder="New password (min 8 characters)"
                          value={props.newUser.newPasswordRepeat}
                          onChange={props.updateNewPasswordRepeat}
                        />
                      </div>
