    ...
    <li class="list-group-item py-5">
      <div class="media">
        <div
          ...
          style="background-image: url(https://www.gravatar.com/avatar/3704fd91da1bfad756b6457a4f373ebd)"
        />
        <div class="media-body">
          ...
          <div>Turn on the light in the living room</div>
        </div>
      </div>
    </li>
    <li class="list-group-item py-5">
      <div class="media">
        <div
          class="media-object avatar avatar-md mr-4"
          style="background-image: url(/assets/icons/android-icon-192x192.png)"
        />
        <div class="media-body">
          <div class="media-heading">
            <small class="float-right text-muted">12 min</small>
          ...
          <div>Sure, turning on the lights right now...</div>
        </div>
      </div>
    </li>
    <li class="list-group-item py-5">
