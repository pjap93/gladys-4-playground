...
const IntegrationPage = connect('currentUrl', actions)(
  ({ currentUrl }) => {
              ...
              <div class="page-header">
                ...
                <div class="page-options d-flex">
                  ...
                  <div class="input-icon ml-2">
                    ...
                    <input type="text" class="form-control w-10" placeholder="Search integrations" />
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-lg-9">
                  <IntegrationCategory currentUrl={currentUrl} />
                </div>
              </div>
            </div>
          </div>
