                ...
                <div class="card-body">
                  <div class="dimmer">
                    <div class="dimmer-content">
                      <h2><Text id="integration.philipsHue.title" /></h2>
                      <p><MarkupText id="integration.philipsHue.introduction" /></p>
                      ...
                      { props.bridges && <p>Click on the toggle to connect to a Philips Hue bridge and imports lights in your Gladys</p> }
                      <div class="card-columns">
                        { props.bridges && props.bridges.map((bridge, index) => (
                          <div class="card">
