          ...
          <form onSubmit={login} class="card">
            <div class="card-body p-6">
              ...
              <div class="form-group">
                ...
                <div class="invalid-feedback"> <Text id="login.invalidEmail" /></div>
              </div>
              ...
              <div class="form-footer">
                <button onClick={login} class="btn btn-primary btn-block" disabled={loginStatus === consts.LoginStatus.Processing}>
