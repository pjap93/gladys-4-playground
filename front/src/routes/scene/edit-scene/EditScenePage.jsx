...
const ScenePage = connect(
  'sceneParamsData,scene,highLightedActions',
  actions
)(
  ({
    sceneParamsData,
        ...
        <div class="my-3 my-md-5">
          <div class="container">
            <div class="page-header">
              ...
              <h1 class="page-title">{scene && scene.name}</h1>
              <div class="page-options d-flex">
                <button onClick={startScene} class="btn btn-sm btn-primary ml-2">
                  Run <i class="fe fe-play" />
                </button>
                <button onClick={saveScene} class="btn btn-sm btn-success ml-2">
                  Save <i class="fe fe-save" />
                </button>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row flex-nowrap" style="overflow-x: auto;">
                      {scene &&
                        scene.actions.map((parallelActions, index) => (
                          <ActionColumn
                            addAction={addAction}
